...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14012 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14012(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14030 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14030(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14031 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14031(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14039 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14039(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14065 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14065(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14077 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14077(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14010,callback){
var map__14011 = p__14010;
var map__14011__$1 = cljs.core.__destructure_map(map__14011);
var input = map__14011__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14011__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14011__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
