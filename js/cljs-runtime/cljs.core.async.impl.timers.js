...
var i_13838 = (0);
while(true){
if((i_13838 < arr.length)){
(arr[i_13838] = null);

var G__13843 = (i_13838 + (1));
i_13838 = G__13843;
continue;
} else {
}
...
var i_13866 = (self__.level + (1));
while(true){
if((i_13866 <= (new_level + (1)))){
(update[i_13866] = self__.header);

var G__13867 = (i_13866 + (1));
i_13866 = G__13867;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13871 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13871[i]));
} else {
x__$2.forward.push((((i < links_13871.length))?(links_13871[i]):null));
}

if((i < links_13871.length)){
(links_13871[i] = x__$2);
} else {
links_13871.push(x__$2);
}
...
var i_13883 = (0);
while(true){
if((i_13883 <= self__.level)){
var links_13885 = (update[i_13883]).forward;
if((x__$1 === (((i_13883 < links_13885.length))?(links_13885[i_13883]):null))){
(links_13885[i_13883] = (x__$1.forward[i_13883]));

var G__13889 = (i_13883 + (1));
i_13883 = G__13889;
continue;
} else {
var G__13890 = (i_13883 + (1));
i_13883 = G__13890;
continue;
}
} else {
...
var G__13923 = nx;
var G__13924 = (level__$1 - (1));
x = G__13923;
level__$1 = G__13924;
continue;
} else {
var G__13925 = x;
var G__13926 = (level__$1 - (1));
x = G__13925;
level__$1 = G__13926;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__13941 = nx;
var G__13942 = (level__$1 - (1));
x = G__13941;
level__$1 = G__13942;
continue;
} else {
var G__13944 = x;
var G__13945 = (level__$1 - (1));
x = G__13944;
level__$1 = G__13945;
continue;
}
